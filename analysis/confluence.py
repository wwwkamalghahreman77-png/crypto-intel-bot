...
def analyze_coiling_setup(df: pd.DataFrame) -> dict:
    """
    تشخیص فشردگی قبل از شکست.

    بررسی:
    1. کاهش ATR / نوسان
    2. فشردگی Bollinger Bands
    3. افزایش تدریجی حجم
    4. OBV صعودی
    5. عدم پامپ شدید
    6. نزدیکی به سقف رنج

    این بخش کاملاً مستقل از SIGNAL / REJECT است.
    """
